...
public class AddPostActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        // Post len kiem tra desc vs photo
        btnPost.setOnClickListener(v->{
            if(!txtDesc.getText().toString().isEmpty()){
                post();

            }else {
                Toast.makeText(this, "Post desc is required", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private  void post(){
        ...
        StringRequest request = new StringRequest(Request.Method.POST,Constant.ADD_POST,response -> {
            ...
            // if request get successed the reponse will return the post
            try {
